...
### Vectorial mediante lista de hijos

#### Eficiencia de operacones

| Operación | Orden |
|--------------|--------------|
| void insertarRaiz(const T& e);    |  1  |
| void insertarHijoIzqdo(nodo n, const T& e);   |  n  |
| void insertarHermDrcho(nodo n, const T& e);   |  n  |
| void eliminarHijoIzqdo(nodo n);   |  1  |
| void eliminarHermDrcho(nodo n);   |  n  |
